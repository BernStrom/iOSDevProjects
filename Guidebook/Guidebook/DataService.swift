...
struct DataService {
    ...
    func getData() -> [City] {
        return [
            City(
                name: "Tokyo",
                summary: "Tokyo serves as Japan's economic center and is the seat of both the Japanese government and the Emperor of Japan.",
                imageName: "tokyo",
                attractions: [
                    Attraction(
...
""",
                        imageName: "pantheon",
                        latLong: "41.898762500696236, 12.476915812472798"
                    )
                ]
            ),
            City(
...
""",
                        imageName: "buckingham",
                        latLong: "51.50148418749087, -0.1410746109020975"
                    )
                ]
            )
        ]
